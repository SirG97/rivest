...
Route::get('/statement', [App\Http\Controllers\UserController::class, 'statement'])->name('statement');
Route::get('/fund', [App\Http\Controllers\UserController::class, 'fund'])->name('fund');
