        ...
        <div class="element-wrapper">
            ...
            <div class="element-box">
                ...
                <form method="POST" action="{{ route('transfer.interbank.store') }}">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-4" for="swift_code">SWIFT/IBAN/Routing Number</label>
                        <div class="col-sm-8">
                            <input class="form-control" name="swift_code" placeholder="Account no" id="swift_code" type="text" required  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                        </div>
                    </div>
                    <div class="form-group row">
